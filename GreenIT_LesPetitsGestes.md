...
On parle souvent de notre empreinte carbone, de la fin du monde, de la décroissance, des catastrophes naturelles. Certaines personnes, très souvent politisé, vont accuser notre modèle néo-capitaliste occidentale et donc vous qui n'êtes pas éclairés. Même si on ne peut nier que notre mode de vie est responsable de la plus part de notre impacte environmental. Il ne faut pas tombé dans l'écueil du :

> Ce n'est pas faute ! Mais celle de la société !
> Je suis la cause de tout les désastres à venir.

Le monde n'est ni tout blanc, ni tout noir mais est fait d'une multitude de nuance de gris.

### CO2 je te hais, mais comment s'en passer

Une première bonne nouvelle dans une europe à 27 pays on ce situe à 11ème place des pays les moins émetteur de CO2 ($10,1 tCO_{2eq}$)^[1].
Si l'on ce compare à nos voisins avec un développement économique et industriel équivalant :

- nous sommes très près derrière l'iItalie ($9,9 tCO_{2eq}$)^[1],
- nous sommes très loin devant l'allemagne ($14,6 tCO_{2eq}$)^[1],
- nous sommes bien derrière l'espagne ($8,8 tCO_{2eq}$)^[1].

Au niveau du monde l'UE fait office 'example'. Depuis 2008 que ce soit en production et importation nette de $CO_2$ les émissions on baissée^[2].
...
C'est une bonne nouvelle mais en 2008 il se produite 2 événements :

1. La crise des Subprimes entraînant un fort ralentissement des investissements.
2. Passage symbolique des 100$US avec un record de 147$US le 11/07/08^[3] conduit à une adaptation des comportements individuel et au début des politiques environnementales.
3. Passage du pic de production pétrolière conventionnel^[4] selon IAE.

On peut affirmer que depuis 2008 l'UE subit une décroissance de ces émissions sûrement dût à la diminution des extractions de pétrole conventionnel. Il faut aussi noté que selon IAE et de son rapport de 2018, elle estime le pic de production pétrolière en 2025^[4] et le consensus s'accorde sur une date comprise entre 2025 et 2030.  

Ainsi que nous le décidions ou non il faudra toujours faire avec moins pétrole, car le pétrole non-conventionnel s'exporte que très peu. Tout comme le charbon.  
...
- 90% restant se répartissent de la façon suivante^[1] :
  ...
  5. Équipements et habilement (8%).

Deuxième bonne nouvelle, on peut donc agir directement sur 90% de nos émissions de $CO_2$ ce qui est de bonne augure pour descendre à $2 tCO_{2eq}/hab$ comme la actée la COP de paris en 2015. Cependant le cabinet de conseil Carbone 4 dans son rapport *Faire sa part ?* estime qu'un engagement dit 'héroïque', avec des investissements pour décarboné son mode vie, ne permet de diminuer que 45%^[5] l'empreinte carbone globale d'un français ou d'une française.

### Chauffe Marcel

> +5°C, la belle affaire ! On utilisera moins de pull.

Avec la COP 26 qui c'est déroulé en 2021, les pays ont redis leur volonté de limité le réchauffement climatique de +2°C pour 2100. Cependant les COP ne sont que des accord de principe sans aucune contrainte ou autorité de suivit.  

Mais finalement ça veux dire quoi 2,3 ou 5°C de plus ?

Première mauvaise nouvelle, notre corps est un très mauvais thermomètre. Il difficile de percevoir avec nos organes une variable que quelques degrés. De plus on parle de température moyenne sur une échelle de temps de 3 siècles ($XIX^{ème}$ - $XXI^{ème}$).  

Une élévation moyenne de la température terrestre de 5°C c'est produite entre -11 700 ans^[6] et le $XIX^{ème}$ siecle. Au plus fort de la période glacière Würm il était possible de ce rendre en angleterre à pieds comme le montre la carte ci dessous :
...
Cette évolution sur plus d'une dizaine de millier d'années à vue une augmentation du niveau de la mer de 120 m et le passage de paysages de Toundra et de Steppe en France aux paysages que nous connaissons actuellement.  

Dans notre ère actuel il est difficilement inimaginable de savoir ce que ferais un tel réchauffement en un laps de temps aussi court. En se concentrant sur une hausse entre 1,5 et 3°C on voit que les conséquences ne sont pas proportionnelle. ![Pourquoi rester sous les 2°C ?](https://bonpote.com/wp-content/uploads/2021/05/Carbon_brief_test_15-768x769.png "Pourquoi rester sous les 2°C ?")

Dans cette illustration en se focalisant uniquement sur la France et en prenant une hausse de 1,5°C :

- Presque 1 une chance sur 2 d'avoir une temperature moyenne estival supérieur aux record entre 1950 et 2017
- Plus de 2 semaines par an avec une temperature minimal la nuit supérieur à 20°C

Bonne nouvelle tout de même, l'europe devrait mieux s'en sortir que les pays proche de l'équateur où la température et le taux d'humidité extérieure sera suffisant pour que quiconque ne se trouvant dans un environnement contrôlé subira la même mort que les personnes âgées lors de la canicule de 2003^[7].
...
La cartographie ci-dessus a été réalisée à partir des travaux du GIEC est publier dans une revue scientifique à comité de lecture *Nature Climate Change* Dans la cartographie (a) ce base sur un scénario de +1,5°C alors que l'autre sur un scénario de +5°C. Les mort serait dues à une hyperthermie, c'est à dire que le corps humain n'aurais plus la possibilité d'évacué la chaleur de son corp.  

Cette forte variation des conséquence est principalement due monoxyde de di-hydrogène à l'état gazeux. Plus vulgairement de la vapeur d'eau. Selon les météorologue une élévation de 1°C de la température de l'atmosphère permet de stocker 20% de vapeur d'eau en plus. Or la vapeur d'eau est le principal gaz à effet de serre. Sans la vapeur d'eau on estime que la temperature de la terre serait de -18°C^[8].  

Heureusement le cycle de l'eau fera retomber l'eau sur terre, mais de façon plus importante. De plus le gradient de température entre le sol (troposhère) 
et la atmosphère (stratosphère) va s'accentuer créer dans mouvement convectif de l'air violent plus important (cyclone, tornade, typhon...)
...
C'est la dernière bonne nouvelle, quelque soit le scénario qu'on choisit. Réduire drastiquement les émissions ou continuer comme on fait le climat de 2050 est déjà écrit et connue.  

Pourquoi cette certitude ? Simplement par l'inertie du système climatique. Il faut comprendre quand on relâche un tonne de $CO_2$ l'atmosphère,
dans 100 ans il en restera encore au moins une demie tonne^[9].  

Vous ne verrez pas de votre vivant vos actions de réduction de CO2 mais les générations futures, elles oui. Il faut profiter de cette fenêtre de tir ou nous avons accès 'facilement' à l'énergie et vivons avec "peu" de contraintes climatique pour amorcé la transition.

## Le green IT notre sauveur

### Les origines

- 1992 : Les états unies lance le programme *Energy star*^[10],
- 1998 : Tenue de la convention Aarthus qui définie l'information environnementale qui permet d'avoir accès a des données quantitatives et qualitatives^[10],
- 2003 : L'UE fixe les obligations des collectivités en matière de mise à disposition de l'information environnementale^[10],
- 2004 : Fondation de la Fédération de la communauté francophone autour de GreenIT.fr^[10],
...
Le green IT ne ce focalise pas uniquement sur la tech ou le code. Toutes entreprises travaillant avec du matériel informatique peut appliquer des mesures du green IT^[11].  

Pour une ESN ou une société disposant d'un serveur, il est possible d'estimer les émissions de $CO_2$ qui produit. Les serveur actuel consomme une puissance de 170W^[12] en prenant une hypothèse de fonctionnement d'un serveur toute une année 1 489 kWh/an (170*365*24) et en multipliant par la production de $CO_2$ par kWh[13] on obtient :

1. Électricité française : $89,34 kgCO_{2eq}$.
2. Électricité canadienne : $276,95 kgCO_{2eq}$.
3. Électricité chinoise : $610,49 kgCO_{2eq}$.
4. Électricité des royaumes unis : $680,47 kgCO_{2eq}$.
5. Électricité des états unis : $777,26 kgCO_{2eq}$.

Ainsi un serveur hébergé en france émettra presque 10 fois moins qu'un même serveur hébergé aux états-unis. Il est donc intéressant dans un contexte de cloudification de choisir d'hébergé ses applications sur des serveurs dont le mix énergétique est faiblement émetteur de $CO_2$. 

Quid alors de résilience en cas d'incendie ou de catastrophes. Quid également du temps de latence.

1. La résilience :
   1. choisir une architecture en micro-service et stocker les micro-service sur des partions distinct,
   2. sauvegarder les données dans une autre zone,
   3. provisionner des VM de secours.
2. La latence :
   1. concevoir des API qui envoie peut de données,
   2. respecter les bonnes pratique de l'écoconception,
   3. proposer une expérience utilisateur qui permet d'attendre quelques seconde.
...
- Le mode de transport domicile-travail pour un trajet de 10km^[17] :
  ...
  - un trajet en vélo à assistance électrice $20 gCO_{2eq}$ (si musculaire alors $0 gCO_{2eq}$).

En prenant l'exemple d'une ESN qui travail sur le développement d'une application sur un sprint 2 semaines et en prenant les hypothèses suivante :

- une personne de l'administration est nécessaires pour 40 personnes,
- l'équipe de développement ce compose de 2 développeu·r·se·s,
...
> Note : Pour convertir des Giga Joules d'energie en litre de carburant, il a été pris comme densité énergétique pour l'essence et le diesel de $0,027 GJ/m^3$^[21].
...
- **Impact Emmanuel (manager)** :
  - 5 page : $(5*10,22)/1000 = 0,05 kgCO_{2eq}$
...
- **La température de son logement**, selon les normes de performance énergétique des bâtiments (RT2005, RT2012 et RE2020) impose comme hypothèse de calcul une température moyenne annuelle du logement à 19°C^[22]. Mais baissé son thermostat de 1°C ça représente quel économie ? -7% de consommation d'energie^[23].
...
- **Les déchets**, ils génèrent également des GES de part leur transport et pour les ordures ménagère par le cycle de traitement (incinération ou enfouissement) 
$707,67 kgCO_{2eq}$^[24] :
...
- **L'électroménager et numérique**, les étiquettes énergétiques change régulièrement, depuis mars 2021 on est retourner d'une note allant de A à F avec des seuils relevé. Ainsi un appareil A+++ peut être classé B ou C^[25]. Vue qu'en France la production d'électricité est faiblement carboné, les émissions de GES seront principalement dues à la production de ces appareils :
...
Par rapport aux $10,8 tCO_{2eq}$ d'émission cela représente qu'une baisse de 27% en changent considérablement son mode de vie.

En prenant les propositions de Carbone 4, de l'ADEME et de l'association négaWatt^[29] on peut arriver à répertorier les vrais gestes, actions et investissement à faire :
...
- Covoiturer pour son trajet domicile-travail fait baisser l'empreinte de son trajet et de faire des économie de carburant. Ceci peut ce cumuler également avec l'utilisation d'un vélo ou d'une trottinette électrique pour des trajet de moins de 5 km. Même dans le nord c'est possible de ce déplacer sous la pluie avec peu d'équipements.
- Prendre une carte de réduction à la SNCF n'a que peut d'effet si on l'utilise pas. La carte est surtout là pour nous inciter à l'utiliser de prendre le train à la place de la voiture et surtout de l'avion.
- Éteindre ses appareils en vielle et ne pas laisser son ordinateur portable ou son smartphone sur le secteur permet d'éviter de gâcher de l'energie. Il n'existe pas encore de chargeurs "intelligents" capable de se couper automatiquement. Par contre il existe des prises programmables qui sont très utiles pour ça.
- Les labels ne sont pas fiable, mais les fabricants sont obligé de mettre l'origine des produits. Si l'indicatif localisation devient prioritaire au prix, l'empreinte carbone de nos achats diminuera significativement.
- "Les antibiotiques ce n'est pas automatique", on peut appliquer se slogan également à la viande. La grande distribution à permis à une grande majorité de français d'avoir de la viande au moins une fois par jours et pourtant les éleveurs français ne se sont pas porter aussi mal. En allant vers des circuits courts on peut manger de la viande de meilleure qualité et aider l'éleveur à relever la tête.

## Des gestes avec peu d'investissement et qui demandent un changement de mentalité

- S'il est difficile voir impossible d'avoir de la viande en circuit court et s'il n'y a pas de contre indications médicale. Il est envisageable de réservé la viande uniquement 
lors des sorties au restaurant ou chez des amis. Évidemment on peut choisir cette option directement par conviction.
- Se fixer un objectif d'émissions de CO2 annuelle est un bon moyen pour géré sa mobilité. Cette objectif doit être atteignable et dépend de votre localisation. [Mon Impact Transport](https://monimpacttransport.fr/ "Mon Impact Transport") avec un feuille de calcul permet d'avoir une estimation par trajet. On peut aussi faire des calculs au réel en utilisant le [tableau données d'entrées des véhicule](#et-lhumain) ainsi que les émission du véhicule (V.7 sur la carte grise)
- Se passer des grandes surface serait l'idéale mais se limiter uniquement aux produits non alimentaire est un grand pas. Mais il n'y a pas que les supermarché, il faut aussi éviter les produits vendue par des primeurs qui viennent de loin.
- Une bonne tartiflette c'est bon et c'est encore meilleure lorsqu'on la réussis. Il ne faut pas tomber dans l'écueil du 100% home made, car ça demande l'achat de matériel faisant grimper l'empreinte de l'équipement électro-ménagé.
- La réutilisation est très bien pour diminuer l'empreinte carbone des biens et services, mais ça demande du temps et aussi des changements sommes tout facile mais avec beaucoup de frein psychologique. Papier toilette, couche, protection hygiénique lavables...
- Le sèche linge rend beaucoup de service, mais si un logement dispose d'un espace extérieure et intérieure pour faire sécher le linge. Il sera plus utile à quelqu'un n'ayant pas cette chance. En revanche avec les portails de VOD, youtube etc. Disposé d'une télévision n'est plus si nécessaire, si en plus la télévision est vielle pourquoi ne pas partir sur un vidéo projecteur (4 fois moins émetteur de CO2 à la fabrication) ou utiliser son second écran.
- En parler avec ses proches pour les sensibilisé et sûrement la chose la plus difficile, car on se heurte à l'acceptabilité et aux certitudes des autres. Cela demande de la pédagogie et de l'empathie.

## Investir pour décarboner

### Le logement

Dès 2023 les logements de classe G ne pourront plus être louer et même si sont logement est soit D ou E il est pertinent d'investir dans la rénovations thermique globale, mais pas n'importe comment :

1. isolation avec des matériaux biosourcé :
   1. toiture,
   2. murs donnant sur l'extérieur,
   3. Plancher bas,
   4. Huisserie.
2. production de chaleur :
   1. remplacer la chaudière gaz/fioul par une pompe à chaleur ou chaudière à bois,
   2. remplacer le ballon d'eau chaude par un chauffe-eau solaire avec a point électrique,
3. autres logement :
   1. faire comme la résidence principale

> Note : l'installation d'une source de production électrique n'est pas pertinente au vue du mix énergétique actuel. Il peut cependant devenir intéressant dans le cas d'une de voiture électrique permettant le stockage de l'energie produite.

### Les véhicules

Il convient de ce poser la question de la réel utilité d'une seconde voiture. Dès solutions plus économique existes, par exemple les vélos cargo à assistance électrique ou les mini voitures comme la Renault TWIZY ou la Citroën Ami. La voiture principale doit rester la voiture de la famille et être utilisé pour des longs trajet. Évidement dans certain cas la seconde voiture est essentielle et aucune autre solution n'est envisageable. La seconde voiture ne doit pas être la norme ou un facteur de réussite social mais une réponse à un problème réel de mobilité.  

Concernant le véhicule principale, il faut éviter les formules location longue durée et voire la location avec option d'achat comme une obligation d'achat. Tout comme les appareils électroniques une voiture à une empreinte non négligeable à la fabrication qu'il faut amortir. Les constructeurs dimensionnent leur véhicule pour 20 ans ou 250 000km. Si le véhicule à moins de 10 ans il est urgent d'attendre avant de le changer, sauf si la famille s'agrandit et que le véhicule ne réponds au besoin de mobilité.  
